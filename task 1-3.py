...
if(a > b and a > c and a > d and a < e):
    print(f"вторым по величине является результат сложения {a}")
...
if (b > a and b > c and b > d and b < e):
    print(f"вторым по величине является результат вычитания {b}")
...
if (c > a and c > b and c > d and c < e):
    print(f"вторым по величине является результат умножения {c}")
...
if (d > a and d > b and d > c and d < e):
    print(f"вторым по величине является результат деления с запятой {d}")
...
if (e > a and e > b and e > c and e < d):
    print(f"вторым по величине является результат целочисленного деления {e}")
